...
async def member(ctx, member: discord.Member):
    ...
    await intros_channel.send(f"Welcome, {member.mention}! Please introduce yourself! What's your favorite food? What movies or shows have you enjoyed recently? Is pineapple a pizza topping? Is a hot dog a sandwich? And other questions in the pins for this channel if need you some inspiration.")
